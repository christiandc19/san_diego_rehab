    ...
    <div className="FamilyTherapy-section">
      <div className="FamilyTherapy-section-content container">
            ...
            <div className="FamilyTherapy-section-header">
              <h1>About Family Therapy</h1>
              <p>Welcome to San Diego Rehab's Family Therapy program. We understand that addiction affects not only the individual struggling with it but also their loved ones. Our Family Therapy program is designed to provide support, education, and healing for families affected by addiction.</p> 
              <p>At San Diego Rehab, we understand that addiction is a family affair, affecting not only the individual struggling with substance use but also their loved ones. Our Family Therapy Program is designed to provide comprehensive support and healing for families impacted by addiction. We believe that involving the entire family in the recovery process is essential for lasting change and rebuilding healthy relationships.</p>
            </div>
