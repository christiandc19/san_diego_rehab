      ...
      <div className="conditions">
        <div>
          <div className="condition-icons-header container">
            ...
            <p>
              San Diego Rehab provides services to adults and
              adolescents who have suffer from depression, anxiety, Bipolar
          ...
          <div className="condition-icons-header container">
            ...
            <p>
              Here at San Diego Rehab, we offer a full array of
              affordable drug rehab programs that can take addicts from detox to
